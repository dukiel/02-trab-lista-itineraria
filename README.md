...
Este projeto implementa uma estrutura de dados para gerenciar itinerários utilizando listas encadeadas/sequenciais em C++.
...
```bash
g++ -I include main.cpp src/*.cpp -o programa
